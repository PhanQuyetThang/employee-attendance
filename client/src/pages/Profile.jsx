...
export default function Profile() {
    ...
    return (
        <Fragment>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col w-4/6">
                        ...
                        <div className='flex flex-col'>
                            ...
                            <div className='mt-4'>
                                <div class="flex flex-col dark:bg-gray-800 dark:border-gray-700">
                                    <label className='text-sm ml-1 mb-1 font-bold text-violet-900'>Username</label>
                                    <input defaultValue={currentUser.username} onChange={handleChange} id="username" scope="row" class="px-6 py-2 border mb-2 rounded font-medium text-sm whitespace-nowrap dark:text-white" />

                                    <label className='text-sm ml-1 mb-1 font-bold text-violet-900'>Email</label>
                                    <input defaultValue={currentUser.email} onChange={handleChange} id="email" class="px-6 py-2 border mb-2 rounded font-medium text-sm whitespace-nowrap dark:text-white" />
                                    <label className='text-sm ml-1 mb-1 font-bold text-violet-900'>Password</label>
                                    <input onChange={handleChange} id="password" placeholder="password..." class="px-6 py-2 border mb-2 rounded font-medium text-sm whitespace-nowrap dark:text-white" />
                                </div>
                            </div>
                    ...
                    <div className='flex flex-col float-right gap-2 w-2/3 rounded border p-3'>
                        ...
                        <div className="flex flex-col gap-3 ml-2">
                            <div className="flex flex-col">
                                ...
                                <input onChange={handleChange} defaultValue={currentUser.phonenumber} id="phonenumber" placeholder="phone number..." className="px-6 py-2 border mb-2 rounded font-medium text-sm dark:text-white" />

                                <label className='text-sm ml-1 mb-1 font-bold text-violet-900'>Address</label>
                                <input onChange={handleChange} defaultValue={currentUser.address} id="address" placeholder="..." className="px-6 py-2 border mb-2 rounded font-medium text-sm whitespace-nowrap dark:text-white" />

                                <label className='text-sm ml-1 mb-1 font-bold text-violet-900'>Department</label>
                                <input onChange={handleChange} defaultValue={currentUser.department} id="department" placeholder="Department" className="px-6 py-2 border mb-2 rounded font-medium text-sm whitespace-nowrap dark:text-white" />
                            </div>
                        </div>
